<%@ page import="main.application.queries.user.GetReceivedFriendRequestsQuery.ReceivedFriendRequestsQueryResponse" %>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<section class="app">
  ...
  <% ReceivedFriendRequestsQueryResponse receivedRequests = (ReceivedFriendRequestsQueryResponse) request.getAttribute("receivedRequests"); %>
  <div class="friend-list">
    <%for (String userRequesting : receivedRequests.getRequests()) { %>
    <div class="friend">
      <div class="friend-name"><a href="user/profile?username=<%=userRequesting%>"><%=userRequesting%></a></div>
      <div class="friend-buttons">

        <form action="friendRequests" method="post">
          <input type="hidden" name="action" value="accept">
          <input type="hidden" name="requestingUsername" value="<%=userRequesting%>">
