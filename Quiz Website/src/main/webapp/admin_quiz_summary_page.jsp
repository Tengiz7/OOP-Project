...
<head>
  ...
  <title>Admin Quiz Summary Page</title>
...
<section class="app">
  ...
  <section class="profile-section">
    ...
    <div class="username-container">
      ...
      <form action="adminQuizSummary" method="post">
        <input type="hidden" name="action" value="clearHistory">
        <input type="hidden" name="currentQuizId" value="<%=quiz.getId()%>">
        <button class="admin-btn clear-history-btn" type="submit">Clear History</button>
      </form>
      <form action="adminQuizSummary" method="post">
        <input type="hidden" name="action" value="deleteQuiz">
        <input type="hidden" name="currentQuizId" value="<%=quiz.getId()%>">
        <button class="admin-btn delete-quiz-btn" type="submit">Delete Quiz</button>
      </form>
    </div>
  </section>
