...
<%@ page import="main.application.queries.user.ChallengeQuery.ChallengeQueryResponse" %>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<section class="app">
  ...
  <% ChallengeQueryResponse challenge = (ChallengeQueryResponse) request.getAttribute("challenge"); %>
  <%DateTimeFormatter formatter = DateTimeFormatter.ofPattern("MMMM d, yyyy", Locale.ENGLISH);%>
  <div class="challenge-detail">
    <div class="challenge-sender">Challenge from <%= challenge.getSenderUsername() %></div>
  ...
  <div class="accept-challenge-container">
    <button class="accept-challenge-btn" onclick="redirectToQuizPage(<%= challenge.getQuizID() %>)">Accept Challenge</button>
  </div>
