<%@ page import="main.application.queries.admin.AllAnnouncements.AllAnnouncementsResponse" %>
...
<section class="app">
  ...
  <% List<AllAnnouncementsResponse> announcements = (List<AllAnnouncementsResponse>) request.getAttribute("announcements"); %>
  <%DateTimeFormatter formatter = DateTimeFormatter.ofPattern("MMMM d, yyyy", Locale.ENGLISH);%>
  <div class="announcement-list">
    <%for (AllAnnouncementsResponse announcementsResponse : announcements) { %>
    <div class="announcement">
      <div class="announcement-subject"><%= announcementsResponse.getSubject() %></div>
      <div class="announcement-content"><%= announcementsResponse.getContent() %></div>
      <div class="announcement-footer">
        <p class="announcement-time">Posted on <%= announcementsResponse.getPublishedAt().format(formatter)%></p>
