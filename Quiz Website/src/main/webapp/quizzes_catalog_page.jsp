...
<section class="app">
  ...
  <section class="card-section">
    ...
    <div class="card-wrapper">
      ...
      <% if(i > 3) { break; }%>
      <div class="card">
        <h1><%= popularQuizzes.get(i).getTitle() %></h1>
        <img src="https://via.placeholder.com/200x150?text=Quiz+1" alt="Card Image 1">
        <button class="btn" onclick="redirectToQuizPage('<%= popularQuizzes.get(i).getId() %>')">Learn More</button>
      </div>
      <% }%>
    </div>
  </section>

  <% List<NewQuizesResponse> newQuizzes = (List<NewQuizesResponse>) request.getAttribute("newQuizzes"); %>
  <section class="card-section">
    <div class="title">
      <h1>New Quizzes</h1>
    </div>
    <div class="card-wrapper">
      <%for (int i = 0; i < newQuizzes.size(); i++) { %>
      <% if(i > 3) { break; }%>
      <div class="card">
        <h1><%= newQuizzes.get(i).getTitle() %></h1>
        <img src="https://via.placeholder.com/200x150?text=Quiz+1" alt="Card Image 1">
        <button class="btn" onclick="redirectToQuizPage('<%= newQuizzes.get(i).getId() %>')">Learn More</button>
      </div>
      <% }%>
    </div>
  </section>
  ...
  <section class="card-section">
    ...
    <div class="card-wrapper">
      <%for (int i = 0; i < takenByMe.size(); i++) { %>
      <% if(i > 3) { break; }%>
      <div class="card">
        <h1><%= takenByMe.get(i).getTitle() %></h1>
        <img src="https://via.placeholder.com/200x150?text=Quiz+1" alt="Card Image 1">
        <button class="btn" onclick="redirectToQuizPage('<%= takenByMe.get(i).getId() %>')">Learn More</button>
      </div>
      <% }%>
    </div>
  </section>
  ...
  <div class="viewAll">
    ...
    <a href="all?filter=takenByMe" class="btn">View All </a>
  </div>
  ...
  <section class="card-section">
    ...
    <div class="card-wrapper">
      <%for (int i = 0; i < createdByMe.size(); i++) { %>
      <% if(i > 3) { break; }%>
      <div class="card">
        <h1><%= createdByMe.get(i).getTitle() %></h1>
        <img src="https://via.placeholder.com/200x150?text=Quiz+1" alt="Card Image 1">
        <button class="btn" onclick="redirectToQuizPage('<%= createdByMe.get(i).getId() %>')">Learn More</button>
      </div>
      <% }%>
    </div>
  </section>
  ...
  <div class="viewAll">
    ...
    <a href="all?filter=createdByMe" class="btn">View All </a>
  </div>
