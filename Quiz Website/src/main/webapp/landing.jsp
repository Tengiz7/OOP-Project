...
<section class="app">
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        <li>
          <a href=http://localhost:8080/Quiz_Website/quiz/quiz_creation_page.jsp>
  ...
  <section class="lorem">
    Welcome to the Quiz Website! Here, you'll embark on an exciting journey into the world of quizzes and challenges. Immerse yourself in a realm of knowledge and fun as you create and take quizzes that tickle your curiosity. Connect with friends and fellow enthusiasts, adding a social flair to your experience. Engage in friendly challenges, where your wits will be put to the test. Stay connected by sending messages and tracking the activities of your friends. And don't miss out on the latest updates and announcements from our dedicated administrators. Join us in exploring a universe of learning and enjoyment!
  </section>
