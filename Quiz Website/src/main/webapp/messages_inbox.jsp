<%@ page import="main.application.queries.user.ReceivedMessagesQuery.ReceivedMessagesQueryResponse" %>
...
<section class="app">
    ...
    <% ReceivedMessagesQueryResponse receivedMessages = (ReceivedMessagesQueryResponse) request.getAttribute("receivedMessages"); %>
    <div class="message-list">
        <%for (Message message : receivedMessages.getMessages()) { %>
        <a class="message-link" href="messageDetail?messageId=<%=message.getId()%>">
            <div class="message">
