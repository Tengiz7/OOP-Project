...
<section class="app">
  ...
  <% String userResponse = (String) request.getAttribute("userResponse");
    String visitingUsername = (String) request.getAttribute("visitingUsername");
    boolean areFriends = (boolean) request.getAttribute("areFriends");
    boolean friendRequestSent = (boolean) request.getAttribute("isFriendRequestSent");
  %>
  <section class="profile-section">
    ...
    <div class="username-container">
      <h2 class="username"><%= userResponse %></h2>
      <%
        if (!userResponse.equals(visitingUsername)) {
          if (areFriends) {
      %>
      <p>You are friends</p>
      <%
      ...
      <form action="sendFriendRequest" method="post">
        <input type="hidden" name="visitingUsername" value="<%= visitingUsername %>">
        <input type="hidden" name="profileUsername" value="<%= userResponse %>">
